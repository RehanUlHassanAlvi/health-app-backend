module.exports = [
  ...
  {
    "concern": "Acne",
    "bodyParts": "Arms,Back,Chest,Lower Face,Midface,Neck,Upper Face",
    "treatments": [
      {
  ...
  },
  {
    ...
    "treatments": [
      ...
      {
        "name": "Kybella",
        "description": "Kybella is a new, noninvasive procedure to reduce fat under the chin- permanently!"
      },
      {
        "name": "AviClear",
        "description": "AviClear is an energy device that uses laser light to uses the power of laser light to target acne at its source and suppress the sebaceous glands that lead to acne breakouts."
  ...
  },
  {
    ...
    "bodyParts": "Chest,Hands,Lower Face,Midface,Upper Face",
    "treatments": [
      {
        "name": "Medical-Grade Skincare Products",
        "description": "Over the counter skincare products are often not enough to tackle notable skincare issues. That\u2019s why working with an aesthetic prodiver to create a skincare routine using medical-grade skincare products is the perfect way to create lasting skin health and appearance improvements."
  ...
  {
    "concern": "Excess Fat",
    "bodyParts": "Abdomen,Arms,Back,Chest,Lower Face,Midface,Neck,Upper Face",
    "treatments": [
      {
        "name": "Medical-Grade Skincare Products",
        "description": "Over the counter skincare products are often not enough to tackle notable skincare issues. That\u2019s why working with an aesthetic prodiver to create a skincare routine using medical-grade skincare products is the perfect way to create lasting skin health and appearance improvements."
  ...
  {
    "concern": "Excess Hair",
    "bodyParts": "Arms,Back,Buttocks,Chest,Intimate,Lower Face,Lower Legs,Thighs,Upper Face",
    "treatments": [
      {
        "name": "Dermaplaning",
  ...
  {
    "concern": "Loose Skin",
    "bodyParts": "Arms,Lower Face,Lower Legs,Midface,Neck,Thighs,Upper Face",
    "treatments": [
      {
        "name": "AviClear",
        "description": "AviClear is an energy device that uses laser light to uses the power of laser light to target acne at its source and suppress the sebaceous glands that lead to acne breakouts."
  ...
  {
    "concern": "Red Spots",
    "bodyParts": "Hands,Lower Face,Midface",
    "treatments": [
      {
        "name": "Chemical Peel",
        "description": "Utilizing chemical peels in a patient\u2019s treatment plan helps remove damaged outer layers and treat everything from acne and uneven skin tone to sun damage and wrinkles."
  ...
  {
    "concern": "Rough Skin",
    "bodyParts": "Lips,Lower Face,Midface,Neck,Upper Face",
    "treatments": [
      {
        "name": "Medical-Grade Skincare Products",
        "description": "Over the counter skincare products are often not enough to tackle notable skincare issues. That\u2019s why working with an aesthetic prodiver to create a skincare routine using medical-grade skincare products is the perfect way to create lasting skin health and appearance improvements."
  ...
  },
  {
    ...
    "bodyParts": "Arms,Chest,Lower Face,Lower Legs,Midface,Neck,Thighs,Upper Face",
    "treatments": [
      {
        "name": "Medical-Grade Skincare Products",
        "description": "Over the counter skincare products are often not enough to tackle notable skincare issues. That\u2019s why working with an aesthetic prodiver to create a skincare routine using medical-grade skincare products is the perfect way to create lasting skin health and appearance improvements."
  ...
  },
  {
    ...
    "bodyParts": "Arms,Back,Chest,Intimate,Lower Face,Lower Legs,Midface,Thighs,Upper Face",
    "treatments": [
      {
        "name": "Dermaplaning",
        "description": "Dermaplaning helps remove dead cells and the fine hairs from the top layer of your skin. It\u2019s a manual skin exfoliation treatment that reveals healthy, fresh, glowing skin."
  ...
  {
    "concern": "Wrinkles",
    "bodyParts": "Arms,Chest,Hands,Lower Face,Midface,Neck,Upper Face",
    "treatments": [
      {
        "name": "Medical-Grade Skincare Products",
        "description": "Over the counter skincare products are often not enough to tackle notable skincare issues. That\u2019s why working with an aesthetic prodiver to create a skincare routine using medical-grade skincare products is the perfect way to create lasting skin health and appearance improvements."
